...
if __name__ == "__main__":
    ...
    # Load test data
    test_dataset = ImageFolder(r"C:\Users\User\Desktop\Programming languages for vs\T\Thesis_Microplastics\dataC\val", transform=evaluator.transform)  
    ...
    evaluator.visualize_predictions(test_loader, num_samples=20)